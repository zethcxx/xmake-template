...
### Unix (Linux/macOS)
```sh
curl -sSL https://github.com/zethcxx/xmake-template/raw/main/install.sh | sh
...
# iwr -useb https://github.com/zethcxx/xmake-template/raw/main/install.ps1 -o "$env:TEMP\_xmake.ps1"; & "$env:TEMP\_xmake.ps1" '<project_name>'
```
